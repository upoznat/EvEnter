...
public class Queues {
    ...
    public static final String WALLET_BUY_TICKET_RESPONSE_QUEUE = "wallet_buy_ticket_response";
    public static final String WALLET_CANCEL_TICKET_RESPONSE_QUEUE = "wallet_cancel_ticket_response";
}
